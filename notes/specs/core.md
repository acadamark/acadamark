...
| `src/core/file-data-keys.js` | String constants for `file.data.*` plugin-bus keys (`ENSCRIBE_CONFIG`, `ENSCRIBE_STRICT_MODE`, `ENSCRIBE_REGISTRY`, `ENSCRIBE_CITATIONS`, `ENSCRIBE_LOADED_SOURCES`, `ENSCRIBE_NOTES_PENDING`, `ENSCRIBE_NUMBERING_PENDING`) | G12 |
