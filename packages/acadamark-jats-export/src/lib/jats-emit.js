// JATS attribute-emit callback for `mapAttributes` (acadamark-core).
//
// Phase 5 slice 5a (2026-05-29). The JATS-target counterpart of
// `acadamark-interpreter/src/lib/html-emit.js`. Both callbacks share
// the same `mapAttributes(node, vocab, target, emit)` iteration shape
// from `acadamark-core/map-attributes.js` (the lift the
// acadamark-core extraction arc deferred, landed in this slice).
//
// Per-kind dispatch:
...
//                  unspecified (most acadamark-specific `data-*`
