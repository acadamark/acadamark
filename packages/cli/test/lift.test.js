...
// The interpreter fixture corpus now lives in the consolidated `enscribe`
// package's test tree (packages/enscribe/test/fixtures).
const INTERP_FIXTURES = join(__dirname, '..', '..', 'enscribe', 'test', 'fixtures');
