...
const _abstract = Object.freeze({
    ...
    "shorthand_examples": [
      ...
      },
      {
        ...
        "ehtml": "<abstract data-word-limit=\"250\">\n  <p>This paper presents…</p>\n</abstract>\n",
      },
    ],
    "interpreter_strategy": "schema",
...
const _align = Object.freeze({
    ...
    "shorthand_examples": [
      {
        "source": "<align>\nx^2 + y^2 &= z^2 \\\\\na + b &= c\n</align>\n",
        "ehtml": "<align>(KaTeX-rendered HTML of \\begin{aligned}...\\end{aligned})</align>\n",
    ...
    "shorthand_examples": [
      {
        ...
        "ehtml": "<aside class=\"frameable-border\"><p>A side note about the elephant.</p></aside>",
      },
      {
        "source": "<aside type=warning .important | Be careful here.>",
        "ehtml": "<aside class=\"important frameable-border\" data-aside-type=\"warning\"><p>Be careful here.</p></aside>",
      },
      {
        ...
        "ehtml": "<aside class=\"frameable-border\" data-aside-type=\"callout\"><p>This is a multi-line callout.</p><p>It can contain multiple paragraphs and other content like <strong>emphasis</strong> and inline references.</p></aside>",
      },
    ],
    "interpreter_strategy": "handler",
    ...
    "shorthand_examples": [
      {
        ...
        "ehtml": "<author>Jane Goodall</author>\n",
...
const _cases = Object.freeze({
    ...
    "shorthand_examples": [
      {
        "source": "<cases>\nx^2 & \\text{if } x \\ge 0 \\\\\n-x^2 & \\text{if } x < 0\n</cases>\n",
        "ehtml": "<cases>(KaTeX-rendered HTML of \\begin{cases}...\\end{cases})</cases>\n",
...
const _cite = Object.freeze({
    ...
    "shorthand_examples": [
      ...
      },
      {
        ...
        "notes": "Citation with a positional prefix and a page range (Pandoc grammar).\n",
      },
      {
      ...
      },
      {
        ...
        "notes": "A form composes with a #409 locator: the page rides the\nparenthetical part of the narrative composite.\n",
      },
    ],
    "interpreter_strategy": "schema",
    "related_plugins": [
...
const _code = Object.freeze({
    ...
    "handler_responsibilities": [
      ...
      "Mirrors the inline-code handler's shape so long-form and sigil forms produce consistent output.",
    ],
    "_sourceFile": "code.md",
  });
    ...
    "shorthand_examples": [
      {
        ...
        "ehtml": "<corollary><corollary-label>Corollary 1.</corollary-label><p>Every prime greater than 2 is odd.</p></corollary>",
      },
      {
        "source": "<corollary #cor:bounded>\nAny continuous function on a closed interval is bounded.\n</corollary>\n",
        "ehtml": "<corollary id=\"cor:bounded\"><corollary-label>Corollary 1.</corollary-label><p>Any continuous function on a closed interval is bounded.</p></corollary>",
      },
    ],
    "interpreter_strategy": "handler",
    ...
    "shorthand_examples": [
      {
        ...
        "ehtml": "<definition><definition-label>Definition 1.</definition-label><p>A <i>group</i> is a set with an associative binary operation, identity, and inverses.</p></definition>",
      },
      {
        ...
        "ehtml": "<definition id=\"def:group\" data-name=\"Group\">A <em>group</em> is a set $G$ together with a binary operation $\\cdot$ satisfying associativity, identity, and inverses.</definition>\n",
      },
    ],
    "interpreter_strategy": "handler",
    "handler_module": "./handlers/theorem.js",
    ...
    "shorthand_examples": [
      {
        ...
        "ehtml": "<pre class=\"mermaid\" data-enscribe-dsl=\"mermaid\">graph LR\n  A[Start] --> B{Decision}\n  B -->|yes| C[OK]\n  B -->|no| D[Stop]</pre>\n",
      ...
      {
        "source": "<diagram abc>\nX:1\nT:Scale\nK:C\nCDEFGABc\n</diagram>\n",
        "ehtml": "<pre class=\"abc\" data-enscribe-dsl=\"abc\">X:1\nT:Scale\nK:C\nCDEFGABc</pre>\n",
...
const _eqnarray = Object.freeze({
    ...
    "shorthand_examples": [
      {
        "source": "<eqnarray>\nf(x) &=& x^2 \\\\\ng(x) &=& 2x\n</eqnarray>\n",
        "ehtml": "<eqnarray>(KaTeX-rendered HTML of \\begin{aligned}...\\end{aligned})</eqnarray>\n",
...
const _example = Object.freeze({
    ...
    "shorthand_examples": [
      ...
      },
      {
        ...
        "ehtml": "<example id=\"ex:integers\">The integers $\\mathbb{Z}$ under addition form a group: the operation is associative, $0$ is the identity, and every integer has an additive inverse.</example>\n",
      },
    ],
    "interpreter_strategy": "handler",
    "handler_module": "./handlers/theorem.js",
    ...
    "shorthand_examples": [
      {
        ...
        "ehtml": "<figure><img alt=\"An adult African elephant.\" src=\"elephant.jpg\"><figcaption><figure-label>Figure 1.</figure-label><p>An adult African elephant.</p></figcaption></figure>",
      ...
      },
      {
        ...
        "ehtml": "<figure data-align=\"right\" id=\"elephant\"><img alt=\"A photograph of an elephant\" src=\"elephant.jpg\"><figcaption><figure-label>Figure 1.</figure-label><p>An adult African elephant photographed in Tanzania.</p></figcaption></figure>",
      ...
      },
      {
        ...
        "ehtml": "<figure data-figure-type=\"table\" id=\"revenue-table\"><figcaption><figure-label>Figure 1.</figure-label><table><caption><table-label>Table 1.</table-label></caption><tbody><tr><th>Quarter</th><th>Revenue</th></tr><tr><td>Q1</td><td>$100M</td></tr><tr><td>Q2</td><td>$120M</td></tr></tbody></table><p>Quarterly revenue for fiscal year 2024.</p></figcaption></figure>",
    ...
    "shorthand_examples": [
      {
        ...
        "ehtml": "<figure class=\"frameable-border\"><p>A short callout.</p><figcaption><figure-label>Figure 1.</figure-label></figcaption></figure>",
      ...
      },
      {
        ...
        "ehtml": "<figure class=\"frameable-border\" data-frame-type=\"note\"><figcaption class=\"title\">Important</figcaption><p>Make sure to read this carefully.</p><figcaption><figure-label>Figure 1.</figure-label></figcaption></figure>",
    ...
    "shorthand_examples": [
      {
        ...
        "ehtml": "<glossary-entry id=\"term:enscribe\">\n  <dt>enscribe</dt>\n  <dd><p>An academic publishing system built on HTML+CSS+JS.</p></dd>\n</glossary-entry>\n",
    ...
    "shorthand_examples": [
      {
        ...
        "ehtml": "<p>Assign with <code>x = 1 </code>at the top of the function.</p>",
      ...
      },
      {
        ...
        "ehtml": "<p>Call <code class=\"language-python\">factorial(n) </code>to recurse.</p>",
    ...
    "shorthand_examples": [
      {
        ...
        "ehtml": "<lemma><lemma-label>Lemma 1.</lemma-label><p>Every continuous function on a compact set attains its maximum.</p></lemma>",
      },
      {
        ...
        "ehtml": "<lemma data-name=\"Zorn\" id=\"lem:zorn\"><lemma-label>Lemma 1 (Zorn).</lemma-label><p>Every non-empty partially-ordered set in which every chain has an upper bound contains a maximal element.</p></lemma>",
      },
    ],
    "interpreter_strategy": "handler",
    "handler_module": "./handlers/theorem.js",
...
const _matrix = Object.freeze({
    ...
    "shorthand_examples": [
      {
        "source": "<matrix>\n1 & 2 \\\\\n3 & 4\n</matrix>\n",
        "ehtml": "<matrix>(KaTeX-rendered HTML of \\begin{matrix}1 & 2 \\\\ 3 & 4\\end{matrix})</matrix>\n",
...
const _note = Object.freeze({
    ...
    "enscribe_attributes": {
      ...
      "kwargs": {
        "placement": {
          ...
          "default": "end",
          "notes": "The note's position — one note type, three positions. \"end\" collects at\narticle-back; \"foot\" collects per top-level unit (footnotes); \"margin\"\nprojects the note's content into the page margin beside its numbered\nmarker (a margin note), per-note and independent of the document\n`note-position` default. \"side\" is a legacy alias for \"margin\" (#333).\nNumbering is independent of position. Document-wide default is \"end\".\n",
        },
        "position": {
          "maps_to": {
            "html": "data-note-placement",
          ...
          "notes": "Alias for \"placement\" (same values, same data-note-placement output).\n`<note position=margin>` is the canonical spelling for a margin note.\n",
        },
        "type": {
          "maps_to": {
            "html": "data-note-type",
    ...
    "shorthand_examples": [
      ...
      {
        "source": "A claim<^ A footnote written with the sigil.>.",
        "notes": "The <^ …> footnote sigil (#416): ergonomic sugar for <note | …>. It desugars\nto <note | A footnote written with the sigil.> — byte-identical output, and\nthe note's position follows the document note-position config just like any\n<note> (a bottom footnote by default). v1 is content-only; use the <note>\nlonghand to id or otherwise attribute a footnote. (No stored golden: the\nrender is exactly the <note> examples above.)\n",
      },
      {
        "source": "A definition<note position=margin | A margin note.>.",
        "ehtml": "<style>.tippy-box[data-animation=fade][data-state=hidden]{opacity:0}[data-tippy-root]{max-width:calc(100vw - 10px)}.tippy-box{position:relative;background-color:#333;color:#fff;border-radius:4px;font-size:14px;line-height:1.4;white-space:normal;outline:0;transition-property:transform,visibility,opacity}.tippy-box[data-placement^=top]>.tippy-arrow{bottom:0}.tippy-box[data-placement^=top]>.tippy-arrow:before{bottom:-7px;left:0;border-width:8px 8px 0;border-top-color:initial;transform-origin:center top}.tippy-box[data-placement^=bottom]>.tippy-arrow{top:0}.tippy-box[data-placement^=bottom]>.tippy-arrow:before{top:-7px;left:0;border-width:0 8px 8px;border-bottom-color:initial;transform-origin:center bottom}.tippy-box[data-placement^=left]>.tippy-arrow{right:0}.tippy-box[data-placement^=left]>.tippy-arrow:before{border-width:8px 0 8px 8px;border-left-color:initial;right:-7px;transform-origin:center left}.tippy-box[data-placement^=right]>.tippy-arrow{left:0}.tippy-box[data-placement^=right]>.tippy-arrow:before{left:-7px;border-width:8px 8px 8px 0;border-right-color:initial;transform-origin:center right}.tippy-box[data-inertia][data-state=visible]{transition-timing-function:cubic-bezier(.54,1.5,.38,1.11)}.tippy-arrow{width:16px;height:16px;color:#333}.tippy-arrow:before{content:\"\";position:absolute;border-color:transparent;border-style:solid}.tippy-content{position:relative;padding:5px 9px;z-index:1} .tippy-box[data-theme~=light-border]{background-color:#fff;background-clip:padding-box;border:1px solid rgba(0,8,16,.15);color:#333;box-shadow:0 4px 14px -2px rgba(0,8,16,.08)}.tippy-box[data-theme~=light-border]>.tippy-backdrop{background-color:#fff}.tippy-box[data-theme~=light-border]>.tippy-arrow:after,.tippy-box[data-theme~=light-border]>.tippy-svg-arrow:after{content:\"\";position:absolute;z-index:-1}.tippy-box[data-theme~=light-border]>.tippy-arrow:after{border-color:transparent;border-style:solid}.tippy-box[data-theme~=light-border][data-placement^=top]>.tippy-arrow:before{border-top-color:#fff}.tippy-box[data-theme~=light-border][data-placement^=top]>.tippy-arrow:after{border-top-color:rgba(0,8,16,.2);border-width:7px 7px 0;top:17px;left:1px}.tippy-box[data-theme~=light-border][data-placement^=top]>.tippy-svg-arrow>svg{top:16px}.tippy-box[data-theme~=light-border][data-placement^=top]>.tippy-svg-arrow:after{top:17px}.tippy-box[data-theme~=light-border][data-placement^=bottom]>.tippy-arrow:before{border-bottom-color:#fff;bottom:16px}.tippy-box[data-theme~=light-border][data-placement^=bottom]>.tippy-arrow:after{border-bottom-color:rgba(0,8,16,.2);border-width:0 7px 7px;bottom:17px;left:1px}.tippy-box[data-theme~=light-border][data-placement^=bottom]>.tippy-svg-arrow>svg{bottom:16px}.tippy-box[data-theme~=light-border][data-placement^=bottom]>.tippy-svg-arrow:after{bottom:17px}.tippy-box[data-theme~=light-border][data-placement^=left]>.tippy-arrow:before{border-left-color:#fff}.tippy-box[data-theme~=light-border][data-placement^=left]>.tippy-arrow:after{border-left-color:rgba(0,8,16,.2);border-width:7px 0 7px 7px;left:17px;top:1px}.tippy-box[data-theme~=light-border][data-placement^=left]>.tippy-svg-arrow>svg{left:11px}.tippy-box[data-theme~=light-border][data-placement^=left]>.tippy-svg-arrow:after{left:12px}.tippy-box[data-theme~=light-border][data-placement^=right]>.tippy-arrow:before{border-right-color:#fff;right:16px}.tippy-box[data-theme~=light-border][data-placement^=right]>.tippy-arrow:after{border-width:7px 7px 7px 0;right:17px;top:1px;border-right-color:rgba(0,8,16,.2)}.tippy-box[data-theme~=light-border][data-placement^=right]>.tippy-svg-arrow>svg{right:11px}.tippy-box[data-theme~=light-border][data-placement^=right]>.tippy-svg-arrow:after{right:12px}.tippy-box[data-theme~=light-border]>.tippy-svg-arrow{fill:#fff}.tippy-box[data-theme~=light-border]>.tippy-svg-arrow:after{background-image:url(data:image/svg+xml;base64,);background-size:16px 6px;width:16px;height:6px} /* Sidenote fallback: collected-to-end items authored as placement=side. * Future margin-positioning themes can detect this class and reposition. */ .sidenote-fallback { font-style: italic; } /* Note list: suppress default <ol>numbering since <sup>N</sup> provides it. */ note-list ol { list-style: none; padding-left: 0; margin: 0; } note-list li { margin-bottom: 0.5em; } /* Figure tooltips: constrain image and caption within the tooltip box. */ .tippy-box figure { margin: 0; } .tippy-box figure img { max-width: 100%; height: auto; display: block; } .tippy-box figure figcaption { font-size: 0.9em; margin-top: 0.5em; color: var(--enscribe-text-secondary); /* #438: dark-aware (was hardcoded #555) */ } /* Table tooltips: compact styling with border grid; overflow-x for wide tables. */ .tippy-content { overflow-x: auto; } .tippy-box table { border-collapse: collapse; width: 100%; font-size: 0.9em; margin: 0; } .tippy-box table th, .tippy-box table td { border: 1px solid var(--enscribe-border); /* #438: dark-aware (was hardcoded #ccc) */ padding: 0.3em 0.6em; text-align: left; } .tippy-box table caption { font-size: 0.9em; margin-bottom: 0.4em; text-align: left; color: var(--enscribe-text-secondary); /* #438: dark-aware (was hardcoded #444) */ } /* ── #438: dark-variant hover-preview tooltip ──────────────────────────────────────────────────── * The Tippy `light-border` theme hardcodes a light box (#fff / #333 / a light border + a white arrow), * so a dark-mode reader who hovers a <ref>/<cite> gets a light tooltip on a dark page. We follow the * page variant WITHOUT re-implementing Tippy's per-placement arrow geometry: four tooltip-local custom * properties default to light-border's own values (so light mode is unchanged), and the two dark scopes * — mirroring default.css's `@media (prefers-color-scheme: dark) :root:not([data-theme-variant=\"light\"])` * + `:root[data-theme-variant=\"dark\"]` — flip just those four to the dark-aware --enscribe-* tokens. The * apply-rules carry a `:root` prefix so they outrank light-border regardless of stylesheet load order. */ :root .tippy-box[data-theme~=\"light-border\"] { --tt-bg: #fff; --tt-fg: #333; --tt-border: rgba(0, 8, 16, 0.15); --tt-arrow-edge: rgba(0, 8, 16, 0.2); background-color: var(--tt-bg); color: var(--tt-fg); border-color: var(--tt-border); } :root .tippy-box[data-theme~=\"light-border\"][data-placement^=\"top\"] > .tippy-arrow::before { border-top-color: var(--tt-bg); } :root .tippy-box[data-theme~=\"light-border\"][data-placement^=\"bottom\"] > .tippy-arrow::before { border-bottom-color: var(--tt-bg); } :root .tippy-box[data-theme~=\"light-border\"][data-placement^=\"left\"] > .tippy-arrow::before { border-left-color: var(--tt-bg); } :root .tippy-box[data-theme~=\"light-border\"][data-placement^=\"right\"] > .tippy-arrow::before { border-right-color: var(--tt-bg); } :root .tippy-box[data-theme~=\"light-border\"][data-placement^=\"top\"] > .tippy-arrow::after { border-top-color: var(--tt-arrow-edge); } :root .tippy-box[data-theme~=\"light-border\"][data-placement^=\"bottom\"] > .tippy-arrow::after { border-bottom-color: var(--tt-arrow-edge); } :root .tippy-box[data-theme~=\"light-border\"][data-placement^=\"left\"] > .tippy-arrow::after { border-left-color: var(--tt-arrow-edge); } :root .tippy-box[data-theme~=\"light-border\"][data-placement^=\"right\"] > .tippy-arrow::after { border-right-color: var(--tt-arrow-edge); } @media (prefers-color-scheme: dark) { :root:not([data-theme-variant=\"light\"]) .tippy-box[data-theme~=\"light-border\"] { --tt-bg: var(--enscribe-bg); --tt-fg: var(--enscribe-text-primary); --tt-border: var(--enscribe-border); --tt-arrow-edge: var(--enscribe-border); } } :root[data-theme-variant=\"dark\"] .tippy-box[data-theme~=\"light-border\"] { --tt-bg: var(--enscribe-bg); --tt-fg: var(--enscribe-text-primary); --tt-border: var(--enscribe-border); --tt-arrow-edge: var(--enscribe-border); } </style><script>/** * @popperjs/core v2.11.8 - MIT License */ !function(e,t){\"object\"==typeof exports&&\"undefined\"!=typeof module?t(exports):\"function\"==typeof define&&define.amd?define([\"exports\"],t):t((e=\"undefined\"!=typeof globalThis?globalThis:e||self).Popper={})}(this,(function(e){\"use strict\";function t(e){if(null==e)return window;if(\"[object Window]\"!==e.toString()){var t=e.ownerDocument;return t&&t.defaultView||window}return e}function n(e){return e instanceof t(e).Element||e instanceof Element}function r(e){return e instanceof t(e).HTMLElement||e instanceof HTMLElement}function o(e){return\"undefined\"!=typeof ShadowRoot&&(e instanceof t(e).ShadowRoot||e instanceof ShadowRoot)}var i=Math.max,a=Math.min,s=Math.round;function f(){var e=navigator.userAgentData;return null!=e&&e.brands&&Array.isArray(e.brands)?e.brands.map((function(e){return e.brand+\"/\"+e.version})).join(\" \"):navigator.userAgent}function c(){return!/^((?!chrome|android).)*safari/i.test(f())}function p(e,o,i){void 0===o&&(o=!1),void 0===i&&(i=!1);var a=e.getBoundingClientRect(),f=1,p=1;o&&r(e)&&(f=e.offsetWidth>0&&s(a.width)/e.offsetWidth||1,p=e.offsetHeight>0&&s(a.height)/e.offsetHeight||1);var u=(n(e)?t(e):window).visualViewport,l=!c()&&i,d=(a.left+(l&&u?u.offsetLeft:0))/f,h=(a.top+(l&&u?u.offsetTop:0))/p,m=a.width/f,v=a.height/p;return{width:m,height:v,top:h,right:d+m,bottom:h+v,left:d,x:d,y:h}}function u(e){var n=t(e);return{scrollLeft:n.pageXOffset,scrollTop:n.pageYOffset}}function l(e){return e?(e.nodeName||\"\").toLowerCase():null}function d(e){return((n(e)?e.ownerDocument:e.document)||window.document).documentElement}function h(e){return p(d(e)).left+u(e).scrollLeft}function m(e){return t(e).getComputedStyle(e)}function v(e){var t=m(e),n=t.overflow,r=t.overflowX,o=t.overflowY;return/auto|scroll|overlay|hidden/.test(n+o+r)}function y(e,n,o){void 0===o&&(o=!1);var i,a,f=r(n),c=r(n)&&function(e){var t=e.getBoundingClientRect(),n=s(t.width)/e.offsetWidth||1,r=s(t.height)/e.offsetHeight||1;return 1!==n||1!==r}(n),m=d(n),y=p(e,c,o),g={scrollLeft:0,scrollTop:0},b={x:0,y:0};return(f||!f&&!o)&&((\"body\"!==l(n)||v(m))&&(g=(i=n)!==t(i)&&r(i)?{scrollLeft:(a=i).scrollLeft,scrollTop:a.scrollTop}:u(i)),r(n)?((b=p(n,!0)).x+=n.clientLeft,b.y+=n.clientTop):m&&(b.x=h(m))),{x:y.left+g.scrollLeft-b.x,y:y.top+g.scrollTop-b.y,width:y.width,height:y.height}}function g(e){var t=p(e),n=e.offsetWidth,r=e.offsetHeight;return Math.abs(t.width-n)<=1&&(n=t.width),Math.abs(t.height-r)<=1&&(r=t.height),{x:e.offsetLeft,y:e.offsetTop,width:n,height:r}}function b(e){return\"html\"===l(e)?e:e.assignedSlot||e.parentNode||(o(e)?e.host:null)||d(e)}function x(e){return[\"html\",\"body\",\"#document\"].indexOf(l(e))>=0?e.ownerDocument.body:r(e)&&v(e)?e:x(b(e))}function w(e,n){var r;void 0===n&&(n=[]);var o=x(e),i=o===(null==(r=e.ownerDocument)?void 0:r.body),a=t(o),s=i?[a].concat(a.visualViewport||[],v(o)?o:[]):o,f=n.concat(s);return i?f:f.concat(w(b(s)))}function O(e){return[\"table\",\"td\",\"th\"].indexOf(l(e))>=0}function j(e){return r(e)&&\"fixed\"!==m(e).position?e.offsetParent:null}function E(e){for(var n=t(e),i=j(e);i&&O(i)&&\"static\"===m(i).position;)i=j(i);return i&&(\"html\"===l(i)||\"body\"===l(i)&&\"static\"===m(i).position)?n:i||function(e){var t=/firefox/i.test(f());if(/Trident/i.test(f())&&r(e)&&\"fixed\"===m(e).position)return null;var n=b(e);for(o(n)&&(n=n.host);r(n)&&[\"html\",\"body\"].indexOf(l(n))<0;){var i=m(n);if(\"none\"!==i.transform||\"none\"!==i.perspective||\"paint\"===i.contain||-1!==[\"transform\",\"perspective\"].indexOf(i.willChange)||t&&\"filter\"===i.willChange||t&&i.filter&&\"none\"!==i.filter)return n;n=n.parentNode}return null}(e)||n}var D=\"top\",A=\"bottom\",L=\"right\",P=\"left\",M=\"auto\",k=[D,A,L,P],W=\"start\",B=\"end\",H=\"viewport\",T=\"popper\",R=k.reduce((function(e,t){return e.concat([t+\"-\"+W,t+\"-\"+B])}),[]),S=[].concat(k,[M]).reduce((function(e,t){return e.concat([t,t+\"-\"+W,t+\"-\"+B])}),[]),V=[\"beforeRead\",\"read\",\"afterRead\",\"beforeMain\",\"main\",\"afterMain\",\"beforeWrite\",\"write\",\"afterWrite\"];function q(e){var t=new Map,n=new Set,r=[];function o(e){n.add(e.name),[].concat(e.requires||[],e.requiresIfExists||[]).forEach((function(e){if(!n.has(e)){var r=t.get(e);r&&o(r)}})),r.push(e)}return e.forEach((function(e){t.set(e.name,e)})),e.forEach((function(e){n.has(e.name)||o(e)})),r}function C(e,t){var n=t.getRootNode&&t.getRootNode();if(e.contains(t))return!0;if(n&&o(n)){var r=t;do{if(r&&e.isSameNode(r))return!0;r=r.parentNode||r.host}while(r)}return!1}function N(e){return Object.assign({},e,{left:e.x,top:e.y,right:e.x+e.width,bottom:e.y+e.height})}function I(e,r,o){return r===H?N(function(e,n){var r=t(e),o=d(e),i=r.visualViewport,a=o.clientWidth,s=o.clientHeight,f=0,p=0;if(i){a=i.width,s=i.height;var u=c();(u||!u&&\"fixed\"===n)&&(f=i.offsetLeft,p=i.offsetTop)}return{width:a,height:s,x:f+h(e),y:p}}(e,o)):n(r)?function(e,t){var n=p(e,!1,\"fixed\"===t);return n.top=n.top+e.clientTop,n.left=n.left+e.clientLeft,n.bottom=n.top+e.clientHeight,n.right=n.left+e.clientWidth,n.width=e.clientWidth,n.height=e.clientHeight,n.x=n.left,n.y=n.top,n}(r,o):N(function(e){var t,n=d(e),r=u(e),o=null==(t=e.ownerDocument)?void 0:t.body,a=i(n.scrollWidth,n.clientWidth,o?o.scrollWidth:0,o?o.clientWidth:0),s=i(n.scrollHeight,n.clientHeight,o?o.scrollHeight:0,o?o.clientHeight:0),f=-r.scrollLeft+h(e),c=-r.scrollTop;return\"rtl\"===m(o||n).direction&&(f+=i(n.clientWidth,o?o.clientWidth:0)-a),{width:a,height:s,x:f,y:c}}(d(e)))}function _(e,t,o,s){var f=\"clippingParents\"===t?function(e){var t=w(b(e)),o=[\"absolute\",\"fixed\"].indexOf(m(e).position)>=0&&r(e)?E(e):e;return n(o)?t.filter((function(e){return n(e)&&C(e,o)&&\"body\"!==l(e)})):[]}(e):[].concat(t),c=[].concat(f,[o]),p=c[0],u=c.reduce((function(t,n){var r=I(e,n,s);return t.top=i(r.top,t.top),t.right=a(r.right,t.right),t.bottom=a(r.bottom,t.bottom),t.left=i(r.left,t.left),t}),I(e,p,s));return u.width=u.right-u.left,u.height=u.bottom-u.top,u.x=u.left,u.y=u.top,u}function F(e){return e.split(\"-\")[0]}function U(e){return e.split(\"-\")[1]}function z(e){return[\"top\",\"bottom\"].indexOf(e)>=0?\"x\":\"y\"}function X(e){var t,n=e.reference,r=e.element,o=e.placement,i=o?F(o):null,a=o?U(o):null,s=n.x+n.width/2-r.width/2,f=n.y+n.height/2-r.height/2;switch(i){case D:t={x:s,y:n.y-r.height};break;case A:t={x:s,y:n.y+n.height};break;case L:t={x:n.x+n.width,y:f};break;case P:t={x:n.x-r.width,y:f};break;default:t={x:n.x,y:n.y}}var c=i?z(i):null;if(null!=c){var p=\"y\"===c?\"height\":\"width\";switch(a){case W:t[c]=t[c]-(n[p]/2-r[p]/2);break;case B:t[c]=t[c]+(n[p]/2-r[p]/2)}}return t}function Y(e){return Object.assign({},{top:0,right:0,bottom:0,left:0},e)}function G(e,t){return t.reduce((function(t,n){return t[n]=e,t}),{})}function J(e,t){void 0===t&&(t={});var r=t,o=r.placement,i=void 0===o?e.placement:o,a=r.strategy,s=void 0===a?e.strategy:a,f=r.boundary,c=void 0===f?\"clippingParents\":f,u=r.rootBoundary,l=void 0===u?H:u,h=r.elementContext,m=void 0===h?T:h,v=r.altBoundary,y=void 0!==v&&v,g=r.padding,b=void 0===g?0:g,x=Y(\"number\"!=typeof b?b:G(b,k)),w=m===T?\"reference\":T,O=e.rects.popper,j=e.elements[y?w:m],E=_(n(j)?j:j.contextElement||d(e.elements.popper),c,l,s),P=p(e.elements.reference),M=X({reference:P,element:O,strategy:\"absolute\",placement:i}),W=N(Object.assign({},O,M)),B=m===T?W:P,R={top:E.top-B.top+x.top,bottom:B.bottom-E.bottom+x.bottom,left:E.left-B.left+x.left,right:B.right-E.right+x.right},S=e.modifiersData.offset;if(m===T&&S){var V=S[i];Object.keys(R).forEach((function(e){var t=[L,A].indexOf(e)>=0?1:-1,n=[D,A].indexOf(e)>=0?\"y\":\"x\";R[e]+=V[n]*t}))}return R}var K={placement:\"bottom\",modifiers:[],strategy:\"absolute\"};function Q(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return!t.some((function(e){return!(e&&\"function\"==typeof e.getBoundingClientRect)}))}function Z(e){void 0===e&&(e={});var t=e,r=t.defaultModifiers,o=void 0===r?[]:r,i=t.defaultOptions,a=void 0===i?K:i;return function(e,t,r){void 0===r&&(r=a);var i,s,f={placement:\"bottom\",orderedModifiers:[],options:Object.assign({},K,a),modifiersData:{},elements:{reference:e,popper:t},attributes:{},styles:{}},c=[],p=!1,u={state:f,setOptions:function(r){var i=\"function\"==typeof r?r(f.options):r;l(),f.options=Object.assign({},a,f.options,i),f.scrollParents={reference:n(e)?w(e):e.contextElement?w(e.contextElement):[],popper:w(t)};var s,p,d=function(e){var t=q(e);return V.reduce((function(e,n){return e.concat(t.filter((function(e){return e.phase===n})))}),[])}((s=[].concat(o,f.options.modifiers),p=s.reduce((function(e,t){var n=e[t.name];return e[t.name]=n?Object.assign({},n,t,{options:Object.assign({},n.options,t.options),data:Object.assign({},n.data,t.data)}):t,e}),{}),Object.keys(p).map((function(e){return p[e]}))));return f.orderedModifiers=d.filter((function(e){return e.enabled})),f.orderedModifiers.forEach((function(e){var t=e.name,n=e.options,r=void 0===n?{}:n,o=e.effect;if(\"function\"==typeof o){var i=o({state:f,name:t,instance:u,options:r}),a=function(){};c.push(i||a)}})),u.update()},forceUpdate:function(){if(!p){var e=f.elements,t=e.reference,n=e.popper;if(Q(t,n)){f.rects={reference:y(t,E(n),\"fixed\"===f.options.strategy),popper:g(n)},f.reset=!1,f.placement=f.options.placement,f.orderedModifiers.forEach((function(e){return f.modifiersData[e.name]=Object.assign({},e.data)}));for(var r=0;r<f.orderedModifiers.length;r++)if(!0!==f.reset){var o=f.orderedModifiers[r],i=o.fn,a=o.options,s=void 0===a?{}:a,c=o.name;\"function\"==typeof i&&(f=i({state:f,options:s,name:c,instance:u})||f)}else f.reset=!1,r=-1}}},update:(i=function(){return new Promise((function(e){u.forceUpdate(),e(f)}))},function(){return s||(s=new Promise((function(e){Promise.resolve().then((function(){s=void 0,e(i())}))}))),s}),destroy:function(){l(),p=!0}};if(!Q(e,t))return u;function l(){c.forEach((function(e){return e()})),c=[]}return u.setOptions(r).then((function(e){!p&&r.onFirstUpdate&&r.onFirstUpdate(e)})),u}}var $={passive:!0};var ee={name:\"eventListeners\",enabled:!0,phase:\"write\",fn:function(){},effect:function(e){var n=e.state,r=e.instance,o=e.options,i=o.scroll,a=void 0===i||i,s=o.resize,f=void 0===s||s,c=t(n.elements.popper),p=[].concat(n.scrollParents.reference,n.scrollParents.popper);return a&&p.forEach((function(e){e.addEventListener(\"scroll\",r.update,$)})),f&&c.addEventListener(\"resize\",r.update,$),function(){a&&p.forEach((function(e){e.removeEventListener(\"scroll\",r.update,$)})),f&&c.removeEventListener(\"resize\",r.update,$)}},data:{}};var te={name:\"popperOffsets\",enabled:!0,phase:\"read\",fn:function(e){var t=e.state,n=e.name;t.modifiersData[n]=X({reference:t.rects.reference,element:t.rects.popper,strategy:\"absolute\",placement:t.placement})},data:{}},ne={top:\"auto\",right:\"auto\",bottom:\"auto\",left:\"auto\"};function re(e){var n,r=e.popper,o=e.popperRect,i=e.placement,a=e.variation,f=e.offsets,c=e.position,p=e.gpuAcceleration,u=e.adaptive,l=e.roundOffsets,h=e.isFixed,v=f.x,y=void 0===v?0:v,g=f.y,b=void 0===g?0:g,x=\"function\"==typeof l?l({x:y,y:b}):{x:y,y:b};y=x.x,b=x.y;var w=f.hasOwnProperty(\"x\"),O=f.hasOwnProperty(\"y\"),j=P,M=D,k=window;if(u){var W=E(r),H=\"clientHeight\",T=\"clientWidth\";if(W===t(r)&&\"static\"!==m(W=d(r)).position&&\"absolute\"===c&&(H=\"scrollHeight\",T=\"scrollWidth\"),W=W,i===D||(i===P||i===L)&&a===B)M=A,b-=(h&&W===k&&k.visualViewport?k.visualViewport.height:W[H])-o.height,b*=p?1:-1;if(i===P||(i===D||i===A)&&a===B)j=L,y-=(h&&W===k&&k.visualViewport?k.visualViewport.width:W[T])-o.width,y*=p?1:-1}var R,S=Object.assign({position:c},u&&ne),V=!0===l?function(e,t){var n=e.x,r=e.y,o=t.devicePixelRatio||1;return{x:s(n*o)/o||0,y:s(r*o)/o||0}}({x:y,y:b},t(r)):{x:y,y:b};return y=V.x,b=V.y,p?Object.assign({},S,((R={})[M]=O?\"0\":\"\",R[j]=w?\"0\":\"\",R.transform=(k.devicePixelRatio||1)<=1?\"translate(\"+y+\"px, \"+b+\"px)\":\"translate3d(\"+y+\"px, \"+b+\"px, 0)\",R)):Object.assign({},S,((n={})[M]=O?b+\"px\":\"\",n[j]=w?y+\"px\":\"\",n.transform=\"\",n))}var oe={name:\"computeStyles\",enabled:!0,phase:\"beforeWrite\",fn:function(e){var t=e.state,n=e.options,r=n.gpuAcceleration,o=void 0===r||r,i=n.adaptive,a=void 0===i||i,s=n.roundOffsets,f=void 0===s||s,c={placement:F(t.placement),variation:U(t.placement),popper:t.elements.popper,popperRect:t.rects.popper,gpuAcceleration:o,isFixed:\"fixed\"===t.options.strategy};null!=t.modifiersData.popperOffsets&&(t.styles.popper=Object.assign({},t.styles.popper,re(Object.assign({},c,{offsets:t.modifiersData.popperOffsets,position:t.options.strategy,adaptive:a,roundOffsets:f})))),null!=t.modifiersData.arrow&&(t.styles.arrow=Object.assign({},t.styles.arrow,re(Object.assign({},c,{offsets:t.modifiersData.arrow,position:\"absolute\",adaptive:!1,roundOffsets:f})))),t.attributes.popper=Object.assign({},t.attributes.popper,{\"data-popper-placement\":t.placement})},data:{}};var ie={name:\"applyStyles\",enabled:!0,phase:\"write\",fn:function(e){var t=e.state;Object.keys(t.elements).forEach((function(e){var n=t.styles[e]||{},o=t.attributes[e]||{},i=t.elements[e];r(i)&&l(i)&&(Object.assign(i.style,n),Object.keys(o).forEach((function(e){var t=o[e];!1===t?i.removeAttribute(e):i.setAttribute(e,!0===t?\"\":t)})))}))},effect:function(e){var t=e.state,n={popper:{position:t.options.strategy,left:\"0\",top:\"0\",margin:\"0\"},arrow:{position:\"absolute\"},reference:{}};return Object.assign(t.elements.popper.style,n.popper),t.styles=n,t.elements.arrow&&Object.assign(t.elements.arrow.style,n.arrow),function(){Object.keys(t.elements).forEach((function(e){var o=t.elements[e],i=t.attributes[e]||{},a=Object.keys(t.styles.hasOwnProperty(e)?t.styles[e]:n[e]).reduce((function(e,t){return e[t]=\"\",e}),{});r(o)&&l(o)&&(Object.assign(o.style,a),Object.keys(i).forEach((function(e){o.removeAttribute(e)})))}))}},requires:[\"computeStyles\"]};var ae={name:\"offset\",enabled:!0,phase:\"main\",requires:[\"popperOffsets\"],fn:function(e){var t=e.state,n=e.options,r=e.name,o=n.offset,i=void 0===o?[0,0]:o,a=S.reduce((function(e,n){return e[n]=function(e,t,n){var r=F(e),o=[P,D].indexOf(r)>=0?-1:1,i=\"function\"==typeof n?n(Object.assign({},t,{placement:e})):n,a=i[0],s=i[1];return a=a||0,s=(s||0)*o,[P,L].indexOf(r)>=0?{x:s,y:a}:{x:a,y:s}}(n,t.rects,i),e}),{}),s=a[t.placement],f=s.x,c=s.y;null!=t.modifiersData.popperOffsets&&(t.modifiersData.popperOffsets.x+=f,t.modifiersData.popperOffsets.y+=c),t.modifiersData[r]=a}},se={left:\"right\",right:\"left\",bottom:\"top\",top:\"bottom\"};function fe(e){return e.replace(/left|right|bottom|top/g,(function(e){return se[e]}))}var ce={start:\"end\",end:\"start\"};function pe(e){return e.replace(/start|end/g,(function(e){return ce[e]}))}function ue(e,t){void 0===t&&(t={});var n=t,r=n.placement,o=n.boundary,i=n.rootBoundary,a=n.padding,s=n.flipVariations,f=n.allowedAutoPlacements,c=void 0===f?S:f,p=U(r),u=p?s?R:R.filter((function(e){return U(e)===p})):k,l=u.filter((function(e){return c.indexOf(e)>=0}));0===l.length&&(l=u);var d=l.reduce((function(t,n){return t[n]=J(e,{placement:n,boundary:o,rootBoundary:i,padding:a})[F(n)],t}),{});return Object.keys(d).sort((function(e,t){return d[e]-d[t]}))}var le={name:\"flip\",enabled:!0,phase:\"main\",fn:function(e){var t=e.state,n=e.options,r=e.name;if(!t.modifiersData[r]._skip){for(var o=n.mainAxis,i=void 0===o||o,a=n.altAxis,s=void 0===a||a,f=n.fallbackPlacements,c=n.padding,p=n.boundary,u=n.rootBoundary,l=n.altBoundary,d=n.flipVariations,h=void 0===d||d,m=n.allowedAutoPlacements,v=t.options.placement,y=F(v),g=f||(y===v||!h?[fe(v)]:function(e){if(F(e)===M)return[];var t=fe(e);return[pe(e),t,pe(t)]}(v)),b=[v].concat(g).reduce((function(e,n){return e.concat(F(n)===M?ue(t,{placement:n,boundary:p,rootBoundary:u,padding:c,flipVariations:h,allowedAutoPlacements:m}):n)}),[]),x=t.rects.reference,w=t.rects.popper,O=new Map,j=!0,E=b[0],k=0;k<b.length;k++){var B=b[k],H=F(B),T=U(B)===W,R=[D,A].indexOf(H)>=0,S=R?\"width\":\"height\",V=J(t,{placement:B,boundary:p,rootBoundary:u,altBoundary:l,padding:c}),q=R?T?L:P:T?A:D;x[S]>w[S]&&(q=fe(q));var C=fe(q),N=[];if(i&&N.push(V[H]<=0),s&&N.push(V[q]<=0,V[C]<=0),N.every((function(e){return e}))){E=B,j=!1;break}O.set(B,N)}if(j)for(var I=function(e){var t=b.find((function(t){var n=O.get(t);if(n)return n.slice(0,e).every((function(e){return e}))}));if(t)return E=t,\"break\"},_=h?3:1;_>0;_--){if(\"break\"===I(_))break}t.placement!==E&&(t.modifiersData[r]._skip=!0,t.placement=E,t.reset=!0)}},requiresIfExists:[\"offset\"],data:{_skip:!1}};function de(e,t,n){return i(e,a(t,n))}var he={name:\"preventOverflow\",enabled:!0,phase:\"main\",fn:function(e){var t=e.state,n=e.options,r=e.name,o=n.mainAxis,s=void 0===o||o,f=n.altAxis,c=void 0!==f&&f,p=n.boundary,u=n.rootBoundary,l=n.altBoundary,d=n.padding,h=n.tether,m=void 0===h||h,v=n.tetherOffset,y=void 0===v?0:v,b=J(t,{boundary:p,rootBoundary:u,padding:d,altBoundary:l}),x=F(t.placement),w=U(t.placement),O=!w,j=z(x),M=\"x\"===j?\"y\":\"x\",k=t.modifiersData.popperOffsets,B=t.rects.reference,H=t.rects.popper,T=\"function\"==typeof y?y(Object.assign({},t.rects,{placement:t.placement})):y,R=\"number\"==typeof T?{mainAxis:T,altAxis:T}:Object.assign({mainAxis:0,altAxis:0},T),S=t.modifiersData.offset?t.modifiersData.offset[t.placement]:null,V={x:0,y:0};if(k){if(s){var q,C=\"y\"===j?D:P,N=\"y\"===j?A:L,I=\"y\"===j?\"height\":\"width\",_=k[j],X=_+b[C],Y=_-b[N],G=m?-H[I]/2:0,K=w===W?B[I]:H[I],Q=w===W?-H[I]:-B[I],Z=t.elements.arrow,$=m&&Z?g(Z):{width:0,height:0},ee=t.modifiersData[\"arrow#persistent\"]?t.modifiersData[\"arrow#persistent\"].padding:{top:0,right:0,bottom:0,left:0},te=ee[C],ne=ee[N],re=de(0,B[I],$[I]),oe=O?B[I]/2-G-re-te-R.mainAxis:K-re-te-R.mainAxis,ie=O?-B[I]/2+G+re+ne+R.mainAxis:Q+re+ne+R.mainAxis,ae=t.elements.arrow&&E(t.elements.arrow),se=ae?\"y\"===j?ae.clientTop||0:ae.clientLeft||0:0,fe=null!=(q=null==S?void 0:S[j])?q:0,ce=_+ie-fe,pe=de(m?a(X,_+oe-fe-se):X,_,m?i(Y,ce):Y);k[j]=pe,V[j]=pe-_}if(c){var ue,le=\"x\"===j?D:P,he=\"x\"===j?A:L,me=k[M],ve=\"y\"===M?\"height\":\"width\",ye=me+b[le],ge=me-b[he],be=-1!==[D,P].indexOf(x),xe=null!=(ue=null==S?void 0:S[M])?ue:0,we=be?ye:me-B[ve]-H[ve]-xe+R.altAxis,Oe=be?me+B[ve]+H[ve]-xe-R.altAxis:ge,je=m&&be?function(e,t,n){var r=de(e,t,n);return r>n?n:r}(we,me,Oe):de(m?we:ye,me,m?Oe:ge);k[M]=je,V[M]=je-me}t.modifiersData[r]=V}},requiresIfExists:[\"offset\"]};var me={name:\"arrow\",enabled:!0,phase:\"main\",fn:function(e){var t,n=e.state,r=e.name,o=e.options,i=n.elements.arrow,a=n.modifiersData.popperOffsets,s=F(n.placement),f=z(s),c=[P,L].indexOf(s)>=0?\"height\":\"width\";if(i&&a){var p=function(e,t){return Y(\"number\"!=typeof(e=\"function\"==typeof e?e(Object.assign({},t.rects,{placement:t.placement})):e)?e:G(e,k))}(o.padding,n),u=g(i),l=\"y\"===f?D:P,d=\"y\"===f?A:L,h=n.rects.reference[c]+n.rects.reference[f]-a[f]-n.rects.popper[c],m=a[f]-n.rects.reference[f],v=E(i),y=v?\"y\"===f?v.clientHeight||0:v.clientWidth||0:0,b=h/2-m/2,x=p[l],w=y-u[c]-p[d],O=y/2-u[c]/2+b,j=de(x,O,w),M=f;n.modifiersData[r]=((t={})[M]=j,t.centerOffset=j-O,t)}},effect:function(e){var t=e.state,n=e.options.element,r=void 0===n?\"[data-popper-arrow]\":n;null!=r&&(\"string\"!=typeof r||(r=t.elements.popper.querySelector(r)))&&C(t.elements.popper,r)&&(t.elements.arrow=r)},requires:[\"popperOffsets\"],requiresIfExists:[\"preventOverflow\"]};function ve(e,t,n){return void 0===n&&(n={x:0,y:0}),{top:e.top-t.height-n.y,right:e.right-t.width+n.x,bottom:e.bottom-t.height+n.y,left:e.left-t.width-n.x}}function ye(e){return[D,L,A,P].some((function(t){return e[t]>=0}))}var ge={name:\"hide\",enabled:!0,phase:\"main\",requiresIfExists:[\"preventOverflow\"],fn:function(e){var t=e.state,n=e.name,r=t.rects.reference,o=t.rects.popper,i=t.modifiersData.preventOverflow,a=J(t,{elementContext:\"reference\"}),s=J(t,{altBoundary:!0}),f=ve(a,r),c=ve(s,o,i),p=ye(f),u=ye(c);t.modifiersData[n]={referenceClippingOffsets:f,popperEscapeOffsets:c,isReferenceHidden:p,hasPopperEscaped:u},t.attributes.popper=Object.assign({},t.attributes.popper,{\"data-popper-reference-hidden\":p,\"data-popper-escaped\":u})}},be=Z({defaultModifiers:[ee,te,oe,ie]}),xe=[ee,te,oe,ie,ae,le,he,me,ge],we=Z({defaultModifiers:xe});e.applyStyles=ie,e.arrow=me,e.computeStyles=oe,e.createPopper=we,e.createPopperLite=be,e.defaultModifiers=xe,e.detectOverflow=J,e.eventListeners=ee,e.flip=le,e.hide=ge,e.offset=ae,e.popperGenerator=Z,e.popperOffsets=te,e.preventOverflow=he,Object.defineProperty(e,\"__esModule\",{value:!0})})); !function(e,t){\"object\"==typeof exports&&\"undefined\"!=typeof module?module.exports=t(require(\"@popperjs/core\")):\"function\"==typeof define&&define.amd?define([\"@popperjs/core\"],t):(e=e||self).tippy=t(e.Popper)}(this,(function(e){\"use strict\";var t={passive:!0,capture:!0},n=function(){return document.body};function r(e,t,n){if(Array.isArray(e)){var r=e[t];return null==r?Array.isArray(n)?n[t]:n:r}return e}function o(e,t){var n={}.toString.call(e);return 0===n.indexOf(\"[object\")&&n.indexOf(t+\"]\")>-1}function i(e,t){return\"function\"==typeof e?e.apply(void 0,t):e}function a(e,t){return 0===t?e:function(r){clearTimeout(n),n=setTimeout((function(){e(r)}),t)};var n}function s(e,t){var n=Object.assign({},e);return t.forEach((function(e){delete n[e]})),n}function u(e){return[].concat(e)}function c(e,t){-1===e.indexOf(t)&&e.push(t)}function p(e){return e.split(\"-\")[0]}function f(e){return[].slice.call(e)}function l(e){return Object.keys(e).reduce((function(t,n){return void 0!==e[n]&&(t[n]=e[n]),t}),{})}function d(){return document.createElement(\"div\")}function v(e){return[\"Element\",\"Fragment\"].some((function(t){return o(e,t)}))}function m(e){return o(e,\"MouseEvent\")}function g(e){return!(!e||!e._tippy||e._tippy.reference!==e)}function h(e){return v(e)?[e]:function(e){return o(e,\"NodeList\")}(e)?f(e):Array.isArray(e)?e:f(document.querySelectorAll(e))}function b(e,t){e.forEach((function(e){e&&(e.style.transitionDuration=t+\"ms\")}))}function y(e,t){e.forEach((function(e){e&&e.setAttribute(\"data-state\",t)}))}function w(e){var t,n=u(e)[0];return null!=n&&null!=(t=n.ownerDocument)&&t.body?n.ownerDocument:document}function E(e,t,n){var r=t+\"EventListener\";[\"transitionend\",\"webkitTransitionEnd\"].forEach((function(t){e[r](t,n)}))}function O(e,t){for(var n=t;n;){var r;if(e.contains(n))return!0;n=null==n.getRootNode||null==(r=n.getRootNode())?void 0:r.host}return!1}var x={isTouch:!1},C=0;function T(){x.isTouch||(x.isTouch=!0,window.performance&&document.addEventListener(\"mousemove\",A))}function A(){var e=performance.now();e-C<20&&(x.isTouch=!1,document.removeEventListener(\"mousemove\",A)),C=e}function L(){var e=document.activeElement;if(g(e)){var t=e._tippy;e.blur&&!t.state.isVisible&&e.blur()}}var D=!!(\"undefined\"!=typeof window&&\"undefined\"!=typeof document)&&!!window.msCrypto,R=Object.assign({appendTo:n,aria:{content:\"auto\",expanded:\"auto\"},delay:0,duration:[300,250],getReferenceClientRect:null,hideOnClick:!0,ignoreAttributes:!1,interactive:!1,interactiveBorder:2,interactiveDebounce:0,moveTransition:\"\",offset:[0,10],onAfterUpdate:function(){},onBeforeUpdate:function(){},onCreate:function(){},onDestroy:function(){},onHidden:function(){},onHide:function(){},onMount:function(){},onShow:function(){},onShown:function(){},onTrigger:function(){},onUntrigger:function(){},onClickOutside:function(){},placement:\"top\",plugins:[],popperOptions:{},render:null,showOnCreate:!1,touch:!0,trigger:\"mouseenter focus\",triggerTarget:null},{animateFill:!1,followCursor:!1,inlinePositioning:!1,sticky:!1},{allowHTML:!1,animation:\"fade\",arrow:!0,content:\"\",inertia:!1,maxWidth:350,role:\"tooltip\",theme:\"\",zIndex:9999}),k=Object.keys(R);function P(e){var t=(e.plugins||[]).reduce((function(t,n){var r,o=n.name,i=n.defaultValue;o&&(t[o]=void 0!==e[o]?e[o]:null!=(r=R[o])?r:i);return t}),{});return Object.assign({},e,t)}function j(e,t){var n=Object.assign({},t,{content:i(t.content,[e])},t.ignoreAttributes?{}:function(e,t){return(t?Object.keys(P(Object.assign({},R,{plugins:t}))):k).reduce((function(t,n){var r=(e.getAttribute(\"data-tippy-\"+n)||\"\").trim();if(!r)return t;if(\"content\"===n)t[n]=r;else try{t[n]=JSON.parse(r)}catch(e){t[n]=r}return t}),{})}(e,t.plugins));return n.aria=Object.assign({},R.aria,n.aria),n.aria={expanded:\"auto\"===n.aria.expanded?t.interactive:n.aria.expanded,content:\"auto\"===n.aria.content?t.interactive?null:\"describedby\":n.aria.content},n}function M(e,t){e.innerHTML=t}function V(e){var t=d();return!0===e?t.className=\"tippy-arrow\":(t.className=\"tippy-svg-arrow\",v(e)?t.appendChild(e):M(t,e)),t}function I(e,t){v(t.content)?(M(e,\"\"),e.appendChild(t.content)):\"function\"!=typeof t.content&&(t.allowHTML?M(e,t.content):e.textContent=t.content)}function S(e){var t=e.firstElementChild,n=f(t.children);return{box:t,content:n.find((function(e){return e.classList.contains(\"tippy-content\")})),arrow:n.find((function(e){return e.classList.contains(\"tippy-arrow\")||e.classList.contains(\"tippy-svg-arrow\")})),backdrop:n.find((function(e){return e.classList.contains(\"tippy-backdrop\")}))}}function N(e){var t=d(),n=d();n.className=\"tippy-box\",n.setAttribute(\"data-state\",\"hidden\"),n.setAttribute(\"tabindex\",\"-1\");var r=d();function o(n,r){var o=S(t),i=o.box,a=o.content,s=o.arrow;r.theme?i.setAttribute(\"data-theme\",r.theme):i.removeAttribute(\"data-theme\"),\"string\"==typeof r.animation?i.setAttribute(\"data-animation\",r.animation):i.removeAttribute(\"data-animation\"),r.inertia?i.setAttribute(\"data-inertia\",\"\"):i.removeAttribute(\"data-inertia\"),i.style.maxWidth=\"number\"==typeof r.maxWidth?r.maxWidth+\"px\":r.maxWidth,r.role?i.setAttribute(\"role\",r.role):i.removeAttribute(\"role\"),n.content===r.content&&n.allowHTML===r.allowHTML||I(a,e.props),r.arrow?s?n.arrow!==r.arrow&&(i.removeChild(s),i.appendChild(V(r.arrow))):i.appendChild(V(r.arrow)):s&&i.removeChild(s)}return r.className=\"tippy-content\",r.setAttribute(\"data-state\",\"hidden\"),I(r,e.props),t.appendChild(n),n.appendChild(r),o(e.props,e.props),{popper:t,onUpdate:o}}N.$$tippy=!0;var B=1,H=[],U=[];function _(o,s){var v,g,h,C,T,A,L,k,M=j(o,Object.assign({},R,P(l(s)))),V=!1,I=!1,N=!1,_=!1,F=[],W=a(we,M.interactiveDebounce),X=B++,Y=(k=M.plugins).filter((function(e,t){return k.indexOf(e)===t})),$={id:X,reference:o,popper:d(),popperInstance:null,props:M,state:{isEnabled:!0,isVisible:!1,isDestroyed:!1,isMounted:!1,isShown:!1},plugins:Y,clearDelayTimeouts:function(){clearTimeout(v),clearTimeout(g),cancelAnimationFrame(h)},setProps:function(e){if($.state.isDestroyed)return;ae(\"onBeforeUpdate\",[$,e]),be();var t=$.props,n=j(o,Object.assign({},t,l(e),{ignoreAttributes:!0}));$.props=n,he(),t.interactiveDebounce!==n.interactiveDebounce&&(ce(),W=a(we,n.interactiveDebounce));t.triggerTarget&&!n.triggerTarget?u(t.triggerTarget).forEach((function(e){e.removeAttribute(\"aria-expanded\")})):n.triggerTarget&&o.removeAttribute(\"aria-expanded\");ue(),ie(),J&&J(t,n);$.popperInstance&&(Ce(),Ae().forEach((function(e){requestAnimationFrame(e._tippy.popperInstance.forceUpdate)})));ae(\"onAfterUpdate\",[$,e])},setContent:function(e){$.setProps({content:e})},show:function(){var e=$.state.isVisible,t=$.state.isDestroyed,o=!$.state.isEnabled,a=x.isTouch&&!$.props.touch,s=r($.props.duration,0,R.duration);if(e||t||o||a)return;if(te().hasAttribute(\"disabled\"))return;if(ae(\"onShow\",[$],!1),!1===$.props.onShow($))return;$.state.isVisible=!0,ee()&&(z.style.visibility=\"visible\");ie(),de(),$.state.isMounted||(z.style.transition=\"none\");if(ee()){var u=re(),p=u.box,f=u.content;b([p,f],0)}A=function(){var e;if($.state.isVisible&&!_){if(_=!0,z.offsetHeight,z.style.transition=$.props.moveTransition,ee()&&$.props.animation){var t=re(),n=t.box,r=t.content;b([n,r],s),y([n,r],\"visible\")}se(),ue(),c(U,$),null==(e=$.popperInstance)||e.forceUpdate(),ae(\"onMount\",[$]),$.props.animation&&ee()&&function(e,t){me(e,t)}(s,(function(){$.state.isShown=!0,ae(\"onShown\",[$])}))}},function(){var e,t=$.props.appendTo,r=te();e=$.props.interactive&&t===n||\"parent\"===t?r.parentNode:i(t,[r]);e.contains(z)||e.appendChild(z);$.state.isMounted=!0,Ce()}()},hide:function(){var e=!$.state.isVisible,t=$.state.isDestroyed,n=!$.state.isEnabled,o=r($.props.duration,1,R.duration);if(e||t||n)return;if(ae(\"onHide\",[$],!1),!1===$.props.onHide($))return;$.state.isVisible=!1,$.state.isShown=!1,_=!1,V=!1,ee()&&(z.style.visibility=\"hidden\");if(ce(),ve(),ie(!0),ee()){var i=re(),a=i.box,s=i.content;$.props.animation&&(b([a,s],o),y([a,s],\"hidden\"))}se(),ue(),$.props.animation?ee()&&function(e,t){me(e,(function(){!$.state.isVisible&&z.parentNode&&z.parentNode.contains(z)&&t()}))}(o,$.unmount):$.unmount()},hideWithInteractivity:function(e){ne().addEventListener(\"mousemove\",W),c(H,W),W(e)},enable:function(){$.state.isEnabled=!0},disable:function(){$.hide(),$.state.isEnabled=!1},unmount:function(){$.state.isVisible&&$.hide();if(!$.state.isMounted)return;Te(),Ae().forEach((function(e){e._tippy.unmount()})),z.parentNode&&z.parentNode.removeChild(z);U=U.filter((function(e){return e!==$})),$.state.isMounted=!1,ae(\"onHidden\",[$])},destroy:function(){if($.state.isDestroyed)return;$.clearDelayTimeouts(),$.unmount(),be(),delete o._tippy,$.state.isDestroyed=!0,ae(\"onDestroy\",[$])}};if(!M.render)return $;var q=M.render($),z=q.popper,J=q.onUpdate;z.setAttribute(\"data-tippy-root\",\"\"),z.id=\"tippy-\"+$.id,$.popper=z,o._tippy=$,z._tippy=$;var G=Y.map((function(e){return e.fn($)})),K=o.hasAttribute(\"aria-expanded\");return he(),ue(),ie(),ae(\"onCreate\",[$]),M.showOnCreate&&Le(),z.addEventListener(\"mouseenter\",(function(){$.props.interactive&&$.state.isVisible&&$.clearDelayTimeouts()})),z.addEventListener(\"mouseleave\",(function(){$.props.interactive&&$.props.trigger.indexOf(\"mouseenter\")>=0&&ne().addEventListener(\"mousemove\",W)})),$;function Q(){var e=$.props.touch;return Array.isArray(e)?e:[e,0]}function Z(){return\"hold\"===Q()[0]}function ee(){var e;return!(null==(e=$.props.render)||!e.$$tippy)}function te(){return L||o}function ne(){var e=te().parentNode;return e?w(e):document}function re(){return S(z)}function oe(e){return $.state.isMounted&&!$.state.isVisible||x.isTouch||C&&\"focus\"===C.type?0:r($.props.delay,e?0:1,R.delay)}function ie(e){void 0===e&&(e=!1),z.style.pointerEvents=$.props.interactive&&!e?\"\":\"none\",z.style.zIndex=\"\"+$.props.zIndex}function ae(e,t,n){var r;(void 0===n&&(n=!0),G.forEach((function(n){n[e]&&n[e].apply(n,t)})),n)&&(r=$.props)[e].apply(r,t)}function se(){var e=$.props.aria;if(e.content){var t=\"aria-\"+e.content,n=z.id;u($.props.triggerTarget||o).forEach((function(e){var r=e.getAttribute(t);if($.state.isVisible)e.setAttribute(t,r?r+\" \"+n:n);else{var o=r&&r.replace(n,\"\").trim();o?e.setAttribute(t,o):e.removeAttribute(t)}}))}}function ue(){!K&&$.props.aria.expanded&&u($.props.triggerTarget||o).forEach((function(e){$.props.interactive?e.setAttribute(\"aria-expanded\",$.state.isVisible&&e===te()?\"true\":\"false\"):e.removeAttribute(\"aria-expanded\")}))}function ce(){ne().removeEventListener(\"mousemove\",W),H=H.filter((function(e){return e!==W}))}function pe(e){if(!x.isTouch||!N&&\"mousedown\"!==e.type){var t=e.composedPath&&e.composedPath()[0]||e.target;if(!$.props.interactive||!O(z,t)){if(u($.props.triggerTarget||o).some((function(e){return O(e,t)}))){if(x.isTouch)return;if($.state.isVisible&&$.props.trigger.indexOf(\"click\")>=0)return}else ae(\"onClickOutside\",[$,e]);!0===$.props.hideOnClick&&($.clearDelayTimeouts(),$.hide(),I=!0,setTimeout((function(){I=!1})),$.state.isMounted||ve())}}}function fe(){N=!0}function le(){N=!1}function de(){var e=ne();e.addEventListener(\"mousedown\",pe,!0),e.addEventListener(\"touchend\",pe,t),e.addEventListener(\"touchstart\",le,t),e.addEventListener(\"touchmove\",fe,t)}function ve(){var e=ne();e.removeEventListener(\"mousedown\",pe,!0),e.removeEventListener(\"touchend\",pe,t),e.removeEventListener(\"touchstart\",le,t),e.removeEventListener(\"touchmove\",fe,t)}function me(e,t){var n=re().box;function r(e){e.target===n&&(E(n,\"remove\",r),t())}if(0===e)return t();E(n,\"remove\",T),E(n,\"add\",r),T=r}function ge(e,t,n){void 0===n&&(n=!1),u($.props.triggerTarget||o).forEach((function(r){r.addEventListener(e,t,n),F.push({node:r,eventType:e,handler:t,options:n})}))}function he(){var e;Z()&&(ge(\"touchstart\",ye,{passive:!0}),ge(\"touchend\",Ee,{passive:!0})),(e=$.props.trigger,e.split(/\\s+/).filter(Boolean)).forEach((function(e){if(\"manual\"!==e)switch(ge(e,ye),e){case\"mouseenter\":ge(\"mouseleave\",Ee);break;case\"focus\":ge(D?\"focusout\":\"blur\",Oe);break;case\"focusin\":ge(\"focusout\",Oe)}}))}function be(){F.forEach((function(e){var t=e.node,n=e.eventType,r=e.handler,o=e.options;t.removeEventListener(n,r,o)})),F=[]}function ye(e){var t,n=!1;if($.state.isEnabled&&!xe(e)&&!I){var r=\"focus\"===(null==(t=C)?void 0:t.type);C=e,L=e.currentTarget,ue(),!$.state.isVisible&&m(e)&&H.forEach((function(t){return t(e)})),\"click\"===e.type&&($.props.trigger.indexOf(\"mouseenter\")<0||V)&&!1!==$.props.hideOnClick&&$.state.isVisible?n=!0:Le(e),\"click\"===e.type&&(V=!n),n&&!r&&De(e)}}function we(e){var t=e.target,n=te().contains(t)||z.contains(t);\"mousemove\"===e.type&&n||function(e,t){var n=t.clientX,r=t.clientY;return e.every((function(e){var t=e.popperRect,o=e.popperState,i=e.props.interactiveBorder,a=p(o.placement),s=o.modifiersData.offset;if(!s)return!0;var u=\"bottom\"===a?s.top.y:0,c=\"top\"===a?s.bottom.y:0,f=\"right\"===a?s.left.x:0,l=\"left\"===a?s.right.x:0,d=t.top-r+u>i,v=r-t.bottom-c>i,m=t.left-n+f>i,g=n-t.right-l>i;return d||v||m||g}))}(Ae().concat(z).map((function(e){var t,n=null==(t=e._tippy.popperInstance)?void 0:t.state;return n?{popperRect:e.getBoundingClientRect(),popperState:n,props:M}:null})).filter(Boolean),e)&&(ce(),De(e))}function Ee(e){xe(e)||$.props.trigger.indexOf(\"click\")>=0&&V||($.props.interactive?$.hideWithInteractivity(e):De(e))}function Oe(e){$.props.trigger.indexOf(\"focusin\")<0&&e.target!==te()||$.props.interactive&&e.relatedTarget&&z.contains(e.relatedTarget)||De(e)}function xe(e){return!!x.isTouch&&Z()!==e.type.indexOf(\"touch\")>=0}function Ce(){Te();var t=$.props,n=t.popperOptions,r=t.placement,i=t.offset,a=t.getReferenceClientRect,s=t.moveTransition,u=ee()?S(z).arrow:null,c=a?{getBoundingClientRect:a,contextElement:a.contextElement||te()}:o,p=[{name:\"offset\",options:{offset:i}},{name:\"preventOverflow\",options:{padding:{top:2,bottom:2,left:5,right:5}}},{name:\"flip\",options:{padding:5}},{name:\"computeStyles\",options:{adaptive:!s}},{name:\"$$tippy\",enabled:!0,phase:\"beforeWrite\",requires:[\"computeStyles\"],fn:function(e){var t=e.state;if(ee()){var n=re().box;[\"placement\",\"reference-hidden\",\"escaped\"].forEach((function(e){\"placement\"===e?n.setAttribute(\"data-placement\",t.placement):t.attributes.popper[\"data-popper-\"+e]?n.setAttribute(\"data-\"+e,\"\"):n.removeAttribute(\"data-\"+e)})),t.attributes.popper={}}}}];ee()&&u&&p.push({name:\"arrow\",options:{element:u,padding:3}}),p.push.apply(p,(null==n?void 0:n.modifiers)||[]),$.popperInstance=e.createPopper(c,z,Object.assign({},n,{placement:r,onFirstUpdate:A,modifiers:p}))}function Te(){$.popperInstance&&($.popperInstance.destroy(),$.popperInstance=null)}function Ae(){return f(z.querySelectorAll(\"[data-tippy-root]\"))}function Le(e){$.clearDelayTimeouts(),e&&ae(\"onTrigger\",[$,e]),de();var t=oe(!0),n=Q(),r=n[0],o=n[1];x.isTouch&&\"hold\"===r&&o&&(t=o),t?v=setTimeout((function(){$.show()}),t):$.show()}function De(e){if($.clearDelayTimeouts(),ae(\"onUntrigger\",[$,e]),$.state.isVisible){if(!($.props.trigger.indexOf(\"mouseenter\")>=0&&$.props.trigger.indexOf(\"click\")>=0&&[\"mouseleave\",\"mousemove\"].indexOf(e.type)>=0&&V)){var t=oe(!1);t?g=setTimeout((function(){$.state.isVisible&&$.hide()}),t):h=requestAnimationFrame((function(){$.hide()}))}}else ve()}}function F(e,n){void 0===n&&(n={});var r=R.plugins.concat(n.plugins||[]);document.addEventListener(\"touchstart\",T,t),window.addEventListener(\"blur\",L);var o=Object.assign({},n,{plugins:r}),i=h(e).reduce((function(e,t){var n=t&&_(t,o);return n&&e.push(n),e}),[]);return v(e)?i[0]:i}F.defaultProps=R,F.setDefaultProps=function(e){Object.keys(e).forEach((function(t){R[t]=e[t]}))},F.currentInput=x;var W=Object.assign({},e.applyStyles,{effect:function(e){var t=e.state,n={popper:{position:t.options.strategy,left:\"0\",top:\"0\",margin:\"0\"},arrow:{position:\"absolute\"},reference:{}};Object.assign(t.elements.popper.style,n.popper),t.styles=n,t.elements.arrow&&Object.assign(t.elements.arrow.style,n.arrow)}}),X={mouseover:\"mouseenter\",focusin:\"focus\",click:\"click\"};var Y={name:\"animateFill\",defaultValue:!1,fn:function(e){var t;if(null==(t=e.props.render)||!t.$$tippy)return{};var n=S(e.popper),r=n.box,o=n.content,i=e.props.animateFill?function(){var e=d();return e.className=\"tippy-backdrop\",y([e],\"hidden\"),e}():null;return{onCreate:function(){i&&(r.insertBefore(i,r.firstElementChild),r.setAttribute(\"data-animatefill\",\"\"),r.style.overflow=\"hidden\",e.setProps({arrow:!1,animation:\"shift-away\"}))},onMount:function(){if(i){var e=r.style.transitionDuration,t=Number(e.replace(\"ms\",\"\"));o.style.transitionDelay=Math.round(t/10)+\"ms\",i.style.transitionDuration=e,y([i],\"visible\")}},onShow:function(){i&&(i.style.transitionDuration=\"0ms\")},onHide:function(){i&&y([i],\"hidden\")}}}};var $={clientX:0,clientY:0},q=[];function z(e){var t=e.clientX,n=e.clientY;$={clientX:t,clientY:n}}var J={name:\"followCursor\",defaultValue:!1,fn:function(e){var t=e.reference,n=w(e.props.triggerTarget||t),r=!1,o=!1,i=!0,a=e.props;function s(){return\"initial\"===e.props.followCursor&&e.state.isVisible}function u(){n.addEventListener(\"mousemove\",f)}function c(){n.removeEventListener(\"mousemove\",f)}function p(){r=!0,e.setProps({getReferenceClientRect:null}),r=!1}function f(n){var r=!n.target||t.contains(n.target),o=e.props.followCursor,i=n.clientX,a=n.clientY,s=t.getBoundingClientRect(),u=i-s.left,c=a-s.top;!r&&e.props.interactive||e.setProps({getReferenceClientRect:function(){var e=t.getBoundingClientRect(),n=i,r=a;\"initial\"===o&&(n=e.left+u,r=e.top+c);var s=\"horizontal\"===o?e.top:r,p=\"vertical\"===o?e.right:n,f=\"horizontal\"===o?e.bottom:r,l=\"vertical\"===o?e.left:n;return{width:p-l,height:f-s,top:s,right:p,bottom:f,left:l}}})}function l(){e.props.followCursor&&(q.push({instance:e,doc:n}),function(e){e.addEventListener(\"mousemove\",z)}(n))}function d(){0===(q=q.filter((function(t){return t.instance!==e}))).filter((function(e){return e.doc===n})).length&&function(e){e.removeEventListener(\"mousemove\",z)}(n)}return{onCreate:l,onDestroy:d,onBeforeUpdate:function(){a=e.props},onAfterUpdate:function(t,n){var i=n.followCursor;r||void 0!==i&&a.followCursor!==i&&(d(),i?(l(),!e.state.isMounted||o||s()||u()):(c(),p()))},onMount:function(){e.props.followCursor&&!o&&(i&&(f($),i=!1),s()||u())},onTrigger:function(e,t){m(t)&&($={clientX:t.clientX,clientY:t.clientY}),o=\"focus\"===t.type},onHidden:function(){e.props.followCursor&&(p(),c(),i=!0)}}}};var G={name:\"inlinePositioning\",defaultValue:!1,fn:function(e){var t,n=e.reference;var r=-1,o=!1,i=[],a={name:\"tippyInlinePositioning\",enabled:!0,phase:\"afterWrite\",fn:function(o){var a=o.state;e.props.inlinePositioning&&(-1!==i.indexOf(a.placement)&&(i=[]),t!==a.placement&&-1===i.indexOf(a.placement)&&(i.push(a.placement),e.setProps({getReferenceClientRect:function(){return function(e){return function(e,t,n,r){if(n.length<2||null===e)return t;if(2===n.length&&r>=0&&n[0].left>n[1].right)return n[r]||t;switch(e){case\"top\":case\"bottom\":var o=n[0],i=n[n.length-1],a=\"top\"===e,s=o.top,u=i.bottom,c=a?o.left:i.left,p=a?o.right:i.right;return{top:s,bottom:u,left:c,right:p,width:p-c,height:u-s};case\"left\":case\"right\":var f=Math.min.apply(Math,n.map((function(e){return e.left}))),l=Math.max.apply(Math,n.map((function(e){return e.right}))),d=n.filter((function(t){return\"left\"===e?t.left===f:t.right===l})),v=d[0].top,m=d[d.length-1].bottom;return{top:v,bottom:m,left:f,right:l,width:l-f,height:m-v};default:return t}}(p(e),n.getBoundingClientRect(),f(n.getClientRects()),r)}(a.placement)}})),t=a.placement)}};function s(){var t;o||(t=function(e,t){var n;return{popperOptions:Object.assign({},e.popperOptions,{modifiers:[].concat(((null==(n=e.popperOptions)?void 0:n.modifiers)||[]).filter((function(e){return e.name!==t.name})),[t])})}}(e.props,a),o=!0,e.setProps(t),o=!1)}return{onCreate:s,onAfterUpdate:s,onTrigger:function(t,n){if(m(n)){var o=f(e.reference.getClientRects()),i=o.find((function(e){return e.left-2<=n.clientX&&e.right+2>=n.clientX&&e.top-2<=n.clientY&&e.bottom+2>=n.clientY})),a=o.indexOf(i);r=a>-1?a:r}},onHidden:function(){r=-1}}}};var K={name:\"sticky\",defaultValue:!1,fn:function(e){var t=e.reference,n=e.popper;function r(t){return!0===e.props.sticky||e.props.sticky===t}var o=null,i=null;function a(){var s=r(\"reference\")?(e.popperInstance?e.popperInstance.state.elements.reference:t).getBoundingClientRect():null,u=r(\"popper\")?n.getBoundingClientRect():null;(s&&Q(o,s)||u&&Q(i,u))&&e.popperInstance&&e.popperInstance.update(),o=s,i=u,e.state.isMounted&&requestAnimationFrame(a)}return{onMount:function(){e.props.sticky&&a()}}}};function Q(e,t){return!e||!t||(e.top!==t.top||e.right!==t.right||e.bottom!==t.bottom||e.left!==t.left)}return F.setDefaultProps({plugins:[Y,J,G,K],render:N}),F.createSingleton=function(e,t){var n;void 0===t&&(t={});var r,o=e,i=[],a=[],c=t.overrides,p=[],f=!1;function l(){a=o.map((function(e){return u(e.props.triggerTarget||e.reference)})).reduce((function(e,t){return e.concat(t)}),[])}function v(){i=o.map((function(e){return e.reference}))}function m(e){o.forEach((function(t){e?t.enable():t.disable()}))}function g(e){return o.map((function(t){var n=t.setProps;return t.setProps=function(o){n(o),t.reference===r&&e.setProps(o)},function(){t.setProps=n}}))}function h(e,t){var n=a.indexOf(t);if(t!==r){r=t;var s=(c||[]).concat(\"content\").reduce((function(e,t){return e[t]=o[n].props[t],e}),{});e.setProps(Object.assign({},s,{getReferenceClientRect:\"function\"==typeof s.getReferenceClientRect?s.getReferenceClientRect:function(){var e;return null==(e=i[n])?void 0:e.getBoundingClientRect()}}))}}m(!1),v(),l();var b={fn:function(){return{onDestroy:function(){m(!0)},onHidden:function(){r=null},onClickOutside:function(e){e.props.showOnCreate&&!f&&(f=!0,r=null)},onShow:function(e){e.props.showOnCreate&&!f&&(f=!0,h(e,i[0]))},onTrigger:function(e,t){h(e,t.currentTarget)}}}},y=F(d(),Object.assign({},s(t,[\"overrides\"]),{plugins:[b].concat(t.plugins||[]),triggerTarget:a,popperOptions:Object.assign({},t.popperOptions,{modifiers:[].concat((null==(n=t.popperOptions)?void 0:n.modifiers)||[],[W])})})),w=y.show;y.show=function(e){if(w(),!r&&null==e)return h(y,i[0]);if(!r||null!=e){if(\"number\"==typeof e)return i[e]&&h(y,i[e]);if(o.indexOf(e)>=0){var t=e.reference;return h(y,t)}return i.indexOf(e)>=0?h(y,e):void 0}},y.showNext=function(){var e=i[0];if(!r)return y.show(0);var t=i.indexOf(r);y.show(i[t+1]||e)},y.showPrevious=function(){var e=i[i.length-1];if(!r)return y.show(e);var t=i.indexOf(r),n=i[t-1]||e;y.show(n)};var E=y.setProps;return y.setProps=function(e){c=e.overrides||c,E(e)},y.setInstances=function(e){m(!0),p.forEach((function(e){return e()})),o=e,m(!1),v(),l(),p=g(y),y.setProps({triggerTarget:a})},p=g(y),y},F.delegate=function(e,n){var r=[],o=[],i=!1,a=n.target,c=s(n,[\"target\"]),p=Object.assign({},c,{trigger:\"manual\",touch:!1}),f=Object.assign({touch:R.touch},c,{showOnCreate:!0}),l=F(e,p);function d(e){if(e.target&&!i){var t=e.target.closest(a);if(t){var r=t.getAttribute(\"data-tippy-trigger\")||n.trigger||R.trigger;if(!t._tippy&&!(\"touchstart\"===e.type&&\"boolean\"==typeof f.touch||\"touchstart\"!==e.type&&r.indexOf(X[e.type])<0)){var s=F(t,f);s&&(o=o.concat(s))}}}}function v(e,t,n,o){void 0===o&&(o=!1),e.addEventListener(t,n,o),r.push({node:e,eventType:t,handler:n,options:o})}return u(l).forEach((function(e){var n=e.destroy,a=e.enable,s=e.disable;e.destroy=function(e){void 0===e&&(e=!0),e&&o.forEach((function(e){e.destroy()})),o=[],r.forEach((function(e){var t=e.node,n=e.eventType,r=e.handler,o=e.options;t.removeEventListener(n,r,o)})),r=[],n()},e.enable=function(){a(),o.forEach((function(e){return e.enable()})),i=!1},e.disable=function(){s(),o.forEach((function(e){return e.disable()})),i=!0},function(e){var n=e.reference;v(n,\"touchstart\",d,t),v(n,\"mouseover\",d),v(n,\"focusin\",d),v(n,\"click\",d)}(e)})),l},F.hideAll=function(e){var t=void 0===e?{}:e,n=t.exclude,r=t.duration;U.forEach((function(e){var t=!1;if(n&&(t=g(n)?e.reference===n:e.popper===n.popper),!t){var o=e.props.duration;e.setProps({duration:r}),e.hide(),e.state.isDestroyed||e.setProps({duration:o})}}))},F.roundArrow='<svg height=\"6\" width=\"16\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M0 6s1.796-.013 4.67-3.615C5.851.9 6.93.006 8 0c1.07-.006 2.148.887 3.343 2.385C14.233 6.005 16 6 16 6H0z\"></svg>',F})); /* Hover-preview initialization for enscribe note markers, cross-reference * links, and citation markers. * * Attaches Tippy.js tooltips to: * - <sup data-note-id=\"...\"> note markers (showing note content) * - <a class=\"ref\" href=\"#...\"> cross-reference links (showing the target element) * - <cite class=\"cite\" data-keys=\"...\"> citation markers (showing bib entries) * * Requires: tippy.js (bundled by enscribe or loaded from CDN). * The tippy-bundle includes @popperjs/core so no separate Popper script needed. */ (function () { /** * Extract clean note content from a <li>element, stripping the leading * <sup> marker and the trailing back-arrow link that appear in the list. * Tooltips should show only the note's prose content. * * @param {Element} noteEl The <li>element from the note list. * @returns {string} innerHTML of the cloned, stripped element. */ function getNoteContent(noteEl) { var clone = noteEl.cloneNode(true); // Remove leading superscript marker (e.g. <sup>2</sup>). var sup = clone.querySelector('sup'); if (sup) sup.remove(); // Remove trailing back-arrow link (e.g. <a class=\"note-backref\">↩</a>). var backref = clone.querySelector('.note-backref'); if (backref) backref.remove(); return clone.innerHTML.trim(); } /** * Extract equation content from a display-math element, stripping the * equation-number span so the tooltip shows only the math itself. * * @param {Element} el The display-math element. * @returns {string} innerHTML of the cloned, stripped element. */ function getEquationContent(el) { var clone = el.cloneNode(true); var numSpan = clone.querySelector('equation-number'); if (numSpan) numSpan.remove(); return clone.innerHTML.trim(); } /** * Extract figure content from a <figure>element, stripping the * figure-label span so the tooltip shows image + caption without \"Figure N.\". * * @param {Element} el The <figure>element. * @returns {string} outerHTML of the cloned, stripped element. */ function getFigureContent(el) { var clone = el.cloneNode(true); var label = clone.querySelector('figure-label'); if (label) label.remove(); return clone.outerHTML; } /** * Get tooltip content for a <table>cross-reference target. * Strips the \"Table N.\" label span to keep the preview compact. * * @param {Element} el The <table>element. * @returns {string} outerHTML of the cloned, stripped element. */ function getTableContent(el) { var clone = el.cloneNode(true); clone.querySelectorAll('table-label').forEach(function(n) { n.remove(); }); return clone.outerHTML; } /** * Dispatch to the appropriate content extractor based on the target element type. * * @param {Element} targetEl The element pointed to by a ref link. * @returns {string} HTML string to use as tooltip content. */ function getRefTargetContent(targetEl) { var tagName = targetEl.tagName.toLowerCase(); if (tagName === 'display-math') return getEquationContent(targetEl); if (tagName === 'figure') return getFigureContent(targetEl); if (tagName === 'table') return getTableContent(targetEl); if (tagName === 'li') return getNoteContent(targetEl); return targetEl.outerHTML; } /** * Attach a Tippy tooltip to a note marker <sup> element. * * @param {Element} marker The <sup data-note-id=\"...\"> element. */ function attachNoteTooltip(marker) { var noteId = marker.getAttribute('data-note-id'); var noteEl = document.getElementById(noteId); if (!noteEl) return; tippy(marker, { content: getNoteContent(noteEl), allowHTML: true, interactive: true, placement: 'top', theme: 'light-border', maxWidth: 400, appendTo: document.body, }); } /** * Attach a Tippy tooltip to an <a class=\"ref\"> cross-reference link. * The tooltip shows the content of the element the ref points to. * Refs pointing to missing targets are silently skipped. * * @param {Element} linkEl The <a class=\"ref\" href=\"#...\"> element. */ function attachRefTooltip(linkEl) { // -preview opt-out: ref-resolution.js / handlers/ref.js stamp // data-no-preview=\"true\" when the author wrote -preview on the <ref>. if (linkEl.getAttribute('data-no-preview') === 'true') return; var href = linkEl.getAttribute('href'); if (!href || href.charAt(0) !== '#') return; var targetId = href.slice(1); var targetEl = document.getElementById(targetId); if (!targetEl) return; var content = getRefTargetContent(targetEl); if (!content) return; var maxWidth = (function() { var t = targetEl.tagName.toLowerCase(); if (t === 'display-math') return 500; if (t === 'table') return 600; return 420; })(); tippy(linkEl, { content: content, allowHTML: true, interactive: false, placement: 'top', theme: 'light-border', maxWidth: maxWidth, appendTo: document.body, }); } /** * Build tooltip content for a <cite class=\"cite\"> element. * Looks up each key in data-keys by finding the #ref-KEY element in the * bibliography and returning its innerHTML. Keys missing from the * bibliography get a placeholder message. * * @param {Element} citeEl The <cite class=\"cite\"> element. * @returns {string} HTML string for the tooltip, or '' if no keys found. */ function getCiteContent(citeEl) { var keysAttr = citeEl.getAttribute('data-keys') || ''; if (!keysAttr) return ''; var keys = keysAttr.split(',').map(function(k) { return k.trim(); }).filter(Boolean); if (keys.length === 0) return ''; var items = keys.map(function(key) { var refEl = document.getElementById('ref-' + key); if (refEl) { return '<li>' + refEl.innerHTML + '</li>'; } return '<li class=\"cite-missing\"><em>' + key + '</em> (not in bibliography)</li>'; }); return '<ul class=\"cite-tooltip-list\">' + items.join('') + '</ul>'; } /** * Attach a Tippy tooltip to a <cite class=\"cite\"> citation marker. * Shows full bibliography entries for each cited key. * cite-error elements are deliberately excluded (no tooltip on errors). * * @param {Element} citeEl The <cite class=\"cite\"> element. */ function attachCiteTooltip(citeEl) { var content = getCiteContent(citeEl); if (!content) return; tippy(citeEl, { content: content, allowHTML: true, interactive: true, placement: 'top', theme: 'light-border', maxWidth: 500, appendTo: document.body, }); } function init() { document.querySelectorAll('sup[data-note-id]').forEach(attachNoteTooltip); document.querySelectorAll('a.ref[href^=\"#\"]').forEach(attachRefTooltip); document.querySelectorAll('cite.cite').forEach(attachCiteTooltip); } if (document.readyState === 'loading') { document.addEventListener('DOMContentLoaded', init); } else { init(); } })(); </script><link href=\"https://fonts.googleapis.com/css2?family=Inter:ital,wght@0,400;0,600;0,700;1,400;1,700&#x26;family=Source+Code+Pro:wght@400&#x26;display=swap\" rel=\"stylesheet\"><style>/* Margin column (#33) — margin notes relocated beside their markers; injected only when used. */ /* ── Default / narrow (the mobile fallback) ────────────────────────────────── */ /* The relocated margin copy hides here; the bottom note-list shows instead. */ sidenote { display: none; } @media (min-width: 900px) { /* Relax the body cap so body + margin gutter can be wider (mirrors the ToC layout); only when a margin layout is present. */ body:has(.enscribe-layout--margin) { max-width: none; padding: 0; } .enscribe-layout--margin { margin: 0 auto; padding: 0 var(--enscribe-content-padding); /* the readable body column plus a margin gutter to its right */ max-width: calc(var(--enscribe-content-width) + var(--enscribe-space-12) + 18rem); } /* The body keeps the readable measure; the gutter to its right holds the notes. */ .enscribe-layout--margin .enscribe-body { max-width: var(--enscribe-content-width); margin-right: calc(var(--enscribe-space-12) + 18rem); } /* The margin copy floats into the right gutter, near its anchor. */ .enscribe-layout--margin sidenote { display: block; float: right; clear: right; width: 18rem; margin-right: -18rem; margin-bottom: var(--enscribe-space-3); font-size: var(--enscribe-text-sm); line-height: var(--enscribe-line-height-tight); color: var(--enscribe-text-secondary); text-indent: 0; } /* The note number, carried verbatim from the bottom-list <sup>. */ .enscribe-layout--margin sidenote > sup { font-family: var(--enscribe-font-sans); font-size: var(--enscribe-text-xs); color: var(--enscribe-link); margin-right: var(--enscribe-space-1); } /* On wide screens the bottom note-list is redundant with the relocated copies. */ .enscribe-layout--margin note-list { display: none; } /* ── ARTICLE ToC + margin combined (#33 part 2, folded loose end) ─────────── An ARTICLE with BOTH a ToC sidebar and margin content uses a three-track grid — ToC | body | margin gutter — so the floats land in a real gutter track instead of overrunning the ToC layout's two-column grid. #459 part 1: gated :not(.enscribe-layout--book) — a book ALWAYS carries .enscribe-layout--toc (BOOK_LAYOUT), so this rule used to match books too and manufacture a phantom third track that fought the book's own 3-column grid and dropped the on-this-page rail into the note gutter (the \"two grids on one wrapper\" collision). Books now route margin through their own section below. */ .enscribe-layout--toc.enscribe-layout--margin:not(.enscribe-layout--book) { display: grid; grid-template-columns: 14rem minmax(0, var(--enscribe-content-width)) 18rem; column-gap: var(--enscribe-space-12); max-width: calc(14rem + var(--enscribe-content-width) + 18rem + 2 * var(--enscribe-space-12)); } /* In the combined grid the body is the middle track and the gutter is the third track, so the floats use the column-gap offset, not the single-layout negative margin against the body. */ .enscribe-layout--toc.enscribe-layout--margin:not(.enscribe-layout--book) .enscribe-body { margin-right: 0; } .enscribe-layout--toc.enscribe-layout--margin:not(.enscribe-layout--book) sidenote { margin-right: calc(-1 * (18rem + var(--enscribe-space-12))); } /* ── BOOK + margin (#459 part 1 — the ruling's layering model) ────────────── A book's reading interface owns its own layout, so margin notes on a book do NOT reuse the article combined grid (disabled above). Instead the book drops its grid and lays out as a single reading column with the two navs FLOATING (fixed) above it: the chapter rail on the left, the on-this-page rail on the right OVER an 18rem note gutter, and the margin-note copies float into that gutter and SCROLL with the text — so they pass BEHIND the fixed right rail (required author's-choice behavior, never a bug — notes/specs/book-navigation.md). The top offset reads --enscribe-site-nav-height so the fixed navs clear a website top bar automatically. Delivered on the single-page compiler surface (the one that projects book margin notes today); the per-chapter surfaces get the rules but not yet the projection (#467). Explicit placement (--book-float) supplies its own docks, so the class-based nav fixing here is guarded :not(--book-float). */ .enscribe-layout--book.enscribe-layout--margin { display: block; max-width: none; padding: 0; } .enscribe-layout--book.enscribe-layout--margin > .enscribe-body { max-width: var(--enscribe-content-width); margin-left: calc(13rem + var(--enscribe-space-12)); /* clear the fixed left rail */ margin-right: calc(18rem + var(--enscribe-space-12)); /* the note gutter (right rail floats over it) */ } .enscribe-layout--book.enscribe-layout--margin > .enscribe-body sidenote { margin-right: calc(-1 * (18rem + var(--enscribe-space-12))); } .enscribe-layout--book.enscribe-layout--margin:not(.enscribe-layout--book-float) .enscribe-chapter-rail, .enscribe-layout--book.enscribe-layout--margin:not(.enscribe-layout--book-float) .enscribe-onthispage { position: fixed; top: calc(var(--enscribe-site-nav-height, 0px) + var(--enscribe-space-8)); width: 13rem; max-height: calc(100vh - var(--enscribe-site-nav-height, 0px) - 2 * var(--enscribe-space-8)); overflow-y: auto; z-index: 30; /* above the scrolling margin notes; below the website top bar (100) */ background: var(--enscribe-bg); /* opaque page-colour panel so the notes pass cleanly BEHIND it */ } .enscribe-layout--book.enscribe-layout--margin:not(.enscribe-layout--book-float) .enscribe-chapter-rail { left: var(--enscribe-space-6); } .enscribe-layout--book.enscribe-layout--margin:not(.enscribe-layout--book-float) .enscribe-onthispage { right: var(--enscribe-space-6); } } </style><div class=\"enscribe-layout enscribe-layout--margin\"><main class=\"enscribe-body\"><article><article-body><p>A definition<sup data-note-id=\"note-1\" id=\"noteref-1\"><a href=\"#note-1\">1</a></sup><sidenote><sup>1</sup> A margin note. </sidenote>.</p></article-body><article-back><note-list class=\"notes\"><ol><li class=\"sidenote-fallback\" id=\"note-1\"><sup>1</sup><p>A margin note.</p><a aria-label=\"back to text\" class=\"note-backref\" href=\"#noteref-1\">↩</a></li></ol></note-list></article-back></article></main></div>",
      },
    ],
    "related_plugins": [
      {
...
const _proposition = Object.freeze({
    ...
    "shorthand_examples": [
      ...
      },
      {
        ...
        "ehtml": "<proposition data-name=\"Cauchy-Schwarz\">For any vectors $u$, $v$ in an inner-product space, $|\\langle u, v \\rangle| \\le \\|u\\| \\, \\|v\\|$.</proposition>\n",
      },
    ],
    "interpreter_strategy": "handler",
    "handler_module": "./handlers/theorem.js",
...
const _ref = Object.freeze({
    ...
    "shorthand_examples": [
      {
        "source": "<fig #fig:scatter | A scatter plot of the results.>\nSee <ref @fig:scatter> for details.\n",
        "html_output": "<figure id=\"fig:scatter\"><figcaption><figure-label>Figure 1.</figure-label><p>A scatter plot of the results.</p></figcaption></figure>\n<p>See <a href=\"#fig:scatter\" class=\"ref\">figure 1</a> for details.</p>\n",
    ...
    "shorthand_examples": [
      {
        ...
        "ehtml": "<remark><remark-label>Remark.</remark-label><p>The converse does not hold in general.</p></remark>",
      },
      {
        "source": "<remark>\nThe hypothesis of compactness is essential here; without it\nthe conclusion fails (consider $f(x) = 1/x$ on $(0, 1]$).\n</remark>\n",
        "ehtml": "<remark>The hypothesis of compactness is essential here; without it the conclusion fails (consider $f(x) = 1/x$ on $(0, 1]$).</remark>\n",
      },
    ],
    "interpreter_strategy": "handler",
    "handler_module": "./handlers/theorem.js",
    ...
    "shorthand_examples": [
      {
        ...
        "ehtml": "<svg viewBox=\"0 0 100 100\" width=\"200\" height=\"200\">\n  <circle cx=\"50\" cy=\"50\" r=\"40\" fill=\"blue\" />\n</svg>\n",
      ...
      },
      {
        ...
        "ehtml": "<figure><svg id=\"fig:diagram\" viewBox=\"0 0 100 100\"><circle cx=\"50\" cy=\"50\" r=\"40\"></svg><figcaption><figure-label>Figure 1.</figure-label> A simple circle</figcaption></figure>",
    ...
    "shorthand_examples": [
      {
        ...
        "ehtml": "<theorem>If $a^2 + b^2 = c^2$ then the triangle is right-angled.</theorem>\n",
      ...
      },
      {
        ...
        "ehtml": "<theorem id=\"thm:pyth\" data-name=\"Pythagoras\">If $a^2 + b^2 = c^2$, the triangle with sides $a$, $b$, $c$ is right-angled.</theorem>\n",
...
const _title = Object.freeze({
    ...
    "shorthand_examples": [
      ...
      },
      {
        ...
        "ehtml": "<book><meta><title>A Comprehensive Guide</title></meta></book>",
