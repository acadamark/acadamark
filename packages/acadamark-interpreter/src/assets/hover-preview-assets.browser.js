...
//
// The two identifiers __ACADAMARK_HOVER_PREVIEW_CSS__ / __ACADAMARK_HOVER_PREVIEW_JS__
...
// define:{ __ACADAMARK_HOVER_PREVIEW_CSS__: <json string>, ... }, so esbuild
...
//
// acadamark-core.md's "bundled-asset alternative" for a server-only path,
// realized for the browser side (Phase 14 Slice 1).

/* global __ACADAMARK_HOVER_PREVIEW_CSS__, __ACADAMARK_HOVER_PREVIEW_JS__ */

export function getHoverPreviewCss() {
  return __ACADAMARK_HOVER_PREVIEW_CSS__;
}

export function getHoverPreviewJs() {
  return __ACADAMARK_HOVER_PREVIEW_JS__;
}
