// Error helpers for the acadamark interpreter.
//
...
const PREFIX = '[acadamark-interpreter] warning:';
...
export function warnSkippedDocType(type) {
  // eslint-disable-next-line no-console
  console.warn(`${PREFIX} document type "${type}" is not handled by acadamarkArticleStructuring; skipping structural wrapping`);
}
