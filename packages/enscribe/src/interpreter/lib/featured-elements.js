...
// (#223 slice 3 / #241).
//
// The two Vocabulary intros (Enscribe Shorthand, eHTML) are LIGHT, curated
...
//   • CANONICAL tagnames only — not shorthand aliases (so headings read the eHTML
...
//     the eHTML list its `.ehtml` expansion too (the eHTML intro DISPLAYS the
//     canonical expansion in a three-part shorthand → eHTML → rendered form).
...
/**
 * Featured constructs for the **eHTML** intro — the semantic-HTML substrate that
 * shorthand expands to. Each is shown as the shorthand source → its canonical
 * `ehtml` expansion → one live render (the "shorthand expands to eHTML" form).
 */
export const FEATURED_EHTML = [
  'section',
  'fig',
  'note',
  'inline-math',
