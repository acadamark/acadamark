...
export const CONFIG_OPTIONS_DOC = [
  ...
  { key: 'number-sections', family: 'Numbering', type: 'boolean', values: null, default: 'off in articles, on in books', scope: 'all',
    description: 'Hierarchical section numbering (1, 1.1, 1.1.1). Off by default for articles, on for books.' },
