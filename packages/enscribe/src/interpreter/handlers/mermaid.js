...
// happens external to enscribe, either in the consumer's browser
...
// blocks by their `data-enscribe-dsl="mermaid"` attribute.
//
...
// is the CDN scanning convention. `data-enscribe-dsl="mermaid"` is the
// enscribe-specific contract for build-time tooling.
//
 ...
 * markup; rendering happens external to enscribe.
 *
