...
//
// All six tags arrive here as enscribeTag nodes with `node.content` as an
 ...
 *
 * @param {object} node - enscribeTag node with tagname "$" or "$$"
 * @returns {string}
 */
 ...
 * @param {object} node   - enscribeTag with one of the canonical math
