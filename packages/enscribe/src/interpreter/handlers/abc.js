...
// external to enscribe, either in the consumer's browser (a small init
...
//   <pre class="abc" data-enscribe-dsl="abc">…source…</pre>
//   [<figcaption>Figure N. caption text</figcaption>]
//
// Unlike Mermaid, abcjs has no DOM-scanning initialization — the consumer
// needs an init script that finds each `data-enscribe-dsl="abc"` element
