...
//                      </li>
//
// These nodes are created only by the enscribeNotes plugin (not by authors).
 ...
 * @param {object} node - enscribeTag with tagname '__note-marker'
 ...
 *
 * @param {object} state
 * @param {object} node - enscribeTag with tagname '__note-list'
 * @returns {import('hast').Element}
 */
 ...
 *
 * @param {object} state
 * @param {object} node - enscribeTag with tagname '__note-list-item'
 * @returns {import('hast').Element}
 */
