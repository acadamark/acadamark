 ...
 */
export function emitLiveShell({ master, title, edit = false, assetBase = './', assets, inline } = {}) {
 ...
 */
export function emitSingleFileShell({ source, title, edit = false, editable = true, assetBase, assets, inline } = {}) {
