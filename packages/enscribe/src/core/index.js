// enscribe core — the inward-pointing shared foundation (the `src/core/`
// subtree of the `enscribe` package).
//
// This barrel re-exports the foundation's public surface. Consumers may import
// either via the barrel (`import { ... } from 'enscribe/core'`) or via the
// per-module subpath exports declared in package.json (e.g.
// `import { DSL_REGISTRY } from 'enscribe/core/dsl-registry'`). Within the
// `enscribe` package, sibling modules import these by relative path.
