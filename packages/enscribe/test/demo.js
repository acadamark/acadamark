/**
 * demo.js — enscribe parser output inspector
 *
 ...
 *   2. All enscribe tags — flat listing of every enscribeTag node found at
...
// ─── Section 2: All enscribe tags (flat, every depth) ─────────────────────

const allTags = []
visit(tree, 'enscribeTag', (node) => { allTags.push(node) })

console.log('\n' + HR)
console.log(`Section 2: All enscribe tags — ${allTags.length} found (block-level and inline)`)
console.log(HR)
