...
- [ ] Multi-file source — remaining pieces: cross-file citations/bibliography, master-level `<library src>` live-loading in the browser ([#197](https://github.com/enscribejs/enscribe/issues/197)), placement markers (toc / endnotes / bibliography), and non-article document types (book, website)
